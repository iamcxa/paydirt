...
start_camp_boss() {
  ...
  if [ -n "\$AGENT_FILE" ] && [ -f "\$AGENT_FILE" ]; then
    claude_cmd="PAYDIRT_ROLE=camp-boss claude --agent '\$AGENT_FILE' --dangerously-skip-permissions 'Start as Camp Boss - display your character greeting and load your journal'"
  else
    claude_cmd="PAYDIRT_ROLE=camp-boss claude --dangerously-skip-permissions"
  fi
